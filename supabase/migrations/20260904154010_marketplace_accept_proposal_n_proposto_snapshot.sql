...
-- Source: production migration history sync — 20260904154010 marketplace_accept_proposal_n_proposto_snapshot
...
BEGIN
  ...
  IF v_prop.grupo_id IS NOT NULL THEN
    -- N_contrato = N_proposto: incluir só os primeiros N_proposto membros
    -- (grupo vivo pode ter N_actual > N_proposto)
    FOR r IN
      SELECT *
