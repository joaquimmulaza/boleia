...
- UI: adaptar Stitch/shadcn à arquitectura do repo (`pages/`, `components/`, `Layout`, rotas em `App.jsx`) — **não** dump cego do HTML Stitch nem do export v0. Só `.js`/`.jsx` + JSDoc.
