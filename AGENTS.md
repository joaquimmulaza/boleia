 ...
 * **S22 UX slice (2026-09-06):** passageiro pode «Renegociar preço» (adenda `pendente_contraparte`); motorista aceita/rejeita; «Sair do acordo» com modalidades A/B/C via `terminateAgreement` (`consensual`, `aviso_previo`, `justa_causa`). Spec: `.specs/features/s22-renegotiate-terminate/quick.md`.
