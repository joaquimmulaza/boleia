            ...
            <>
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  required
                />
                {errors?.nome && <span className="text-red-500 text-xs font-medium ml-1">{errors.nome}</span>}
              </div>
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  required
                />
                {errors?.telefone && <span className="text-red-500 text-xs font-medium ml-1">{errors.telefone}</span>}
              </div>
            </>
          )}
